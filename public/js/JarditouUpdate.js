// validation java du formulaire de modif
document .querySelector("#verifmodif").onsubmit = function checkForm(f) 
{
// variable a true qui sera verfifier à chaque condition
    var check = true;

//creation des variables obligatoire :  on recupere les valeurs entrées grace à l'identifiant    
...
// reinitialise le champ erreur 
    ...
    // regex qui accepte tous les caracteres numerique sous la forme d'un prix
